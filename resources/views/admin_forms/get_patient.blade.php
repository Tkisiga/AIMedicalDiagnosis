                ...
                <div class="mainpanel">
                    ...
                    <div class="tab-pane" id="Patient info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="firstname" class="form-control" title="Your name is required!" />
                            </div>
                        </div><!-- form-group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="lastname" class="form-control" title="Your name is required!"/>
                            </div>
                        </div><!-- form-group -->
