...
<section class="ftco-services ftco-no-pb">
    ...
    <div class="media block-6 d-block text-center">
        ...
        <p>Dr.JEBT keeps patients' information protected and safe with restricted access</p>
        </div>
    </div>      
    </div>
    ...
    <div class="media block-6 d-block text-center">
        ...
        <div class="media-body p-2 mt-3">
        <h3 class="heading">Outdoor Prognosis</h3>
        <p>Dr.JEBT can perform a prognosis with symptoms presented without the doctor's examination</p>
        </div>
    </div>      
    </div>
    ...
    <div class="media block-6 d-block text-center">
        ...
        <p>Dr.JEBT provides services all throughout </p>
        </div>
    </div>      
    </div>
</div>
